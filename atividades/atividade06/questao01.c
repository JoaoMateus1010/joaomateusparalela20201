...
int main(int argc, char *argv[]) {
    ...
    /*
        MPI_Allreduce equivale ao MPI_reduce seguido de um MPI_Bcast
    */
    MPI_Reduce(&sum_local,&sum_global,1,MPI_FLOAT,MPI_SUM,ROOT,MPI_COMM_WORLD);
    MPI_Bcast(&sum_global,1,MPI_FLOAT,ROOT,MPI_COMM_WORLD);
