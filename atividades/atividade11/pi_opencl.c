...
int main (int argc, char *argv[]) {
	...
	if (WINDOWS) fopen_s(&programHandle, "pi_by_Leibniz_series.cl", "r");             // Alterei para fopen_s
	if (LINUX) programHandle = fopen("pi_by_Leibniz_series.cl", "r");
	...
	ckKernel = clCreateKernel(cpProgram, "pi_Leibniz", &ciErr);
